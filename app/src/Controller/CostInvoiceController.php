...
#[Route('/invoices/cost')]
class CostInvoiceController extends AbstractController
{
    #[Route('/', name: 'cost_invoice_list', methods: ['GET'])]
    public function list(InvoiceRepository $repo): Response
    {
        return $this->render('invoice/cost/list.html.twig', [
            'invoices' => $repo->findBy(['type' => 'cost']),
        ]);
    }

    #[Route('/new', name: 'cost_invoice_new', methods: ['GET', 'POST'])]
    public function new(
        Request $request,
        ...
        if ($request->isMethod('POST')) {
            ...
            return $this->redirectToRoute('cost_invoice_list');
        }
    ...
    #[Route('/{id}/edit', name: 'cost_invoice_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}/delete', name: 'cost_invoice_delete', methods: ['POST'])]
